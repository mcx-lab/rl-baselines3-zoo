...
class SimulationParameters(object):
    ...
    camera_distance = attr.ib(type=float, default=0.4)
    camera_yaw = attr.ib(type=float, default=-10)
    camera_pitch = attr.ib(type=float, default=-10)
    render_width = attr.ib(type=int, default=1200)
    render_height = attr.ib(type=int, default=900)
