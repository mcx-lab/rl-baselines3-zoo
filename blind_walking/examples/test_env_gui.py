...
from blind_walking.envs.env_modifiers import heightfield, bcastairs, stairs
from blind_walking.robots import a1, aliengo, laikago, robot_config
from tqdm import tqdm

FLAGS = flags.FLAGS
flags.DEFINE_enum("robot_type", "Aliengo", ["A1", "Aliengo", "Laikago"], "Robot Type.")
flags.DEFINE_enum(
    "motor_control_mode",
    "Torque",
    ["Torque", "Position", "Hybrid"],
    "Motor Control Mode.",
)
flags.DEFINE_bool("on_rack", False, "Whether to put the robot on rack.")
flags.DEFINE_string("video_dir", None, "Where to save video (or None for not saving).")

ROBOT_CLASS_MAP = {"A1": a1.A1, "Aliengo": aliengo.Aliengo, "Laikago": laikago.Laikago}
...
def main(_):
    ...
    action_median = (action_low + action_high) / 2.0
