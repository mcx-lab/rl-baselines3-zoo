...
def main():  # noqa: C901
    ...
    successes = []
    reset_manual_override = "heightfield"
    ...
    for sensor_name in sensor_names:
        raw_loggers[sensor_name] = Logger(f"raw_{sensor_name}_{reset_manual_override}_{modification_suffix}")
        filtered_loggers[sensor_name] = Logger(f"filtered_{sensor_name}_{reset_manual_override}_{modification_suffix}")
