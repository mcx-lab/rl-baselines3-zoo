...
#  do i need to change stuffs from here?
...
URDF_FILENAME = "data/aliengo/urdf/aliengo.urdf"
...
class Aliengo(minitaur.Minitaur):
    ...
    #  need to change but not in use (from Daniel)
    ...
    def _LoadRobotURDF(self):
        aliengo_urdf_path = self.GetURDFFile()
    ...
    def ApplyAction(self, motor_commands, motor_control_mode=None):
        ...
        super(Aliengo, self).ApplyAction(motor_commands, motor_control_mode)
