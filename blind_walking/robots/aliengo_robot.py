...
# For real robot. only changed name from a1 to aliengo 
...
from blind_walking.robots import aliengo, aliengo_robot_velocity_estimator, laikago_pose_utils, minitaur, robot_config
...
URDF_FILENAME = "../../data/aliengo/aliengo.urdf"
...
class AliengoRobot(aliengo.Aliengo):
    ...
    def __init__(self, pybullet_client, time_step=0.002, **kwargs):
        ...
        self._velocity_estimator = aliengo_robot_velocity_estimator.VelocityEstimator(self)
    ...
    def ReceiveObservation(self):
        ...
        Synchronous ReceiveObservation is not supported in aliengo,
    ...
    def ApplyAction(self, motor_commands, motor_control_mode=None):
        ...
        if motor_control_mode == robot_config.MotorControlMode.POSITION:
            ...
            raise ValueError("Unknown motor control mode for Aliengo robot: {}.".format(motor_control_mode))
