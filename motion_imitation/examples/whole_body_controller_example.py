...
from mpc_controller import locomotion_controller, openloop_gait_generator, raibert_swing_leg_controller
...
def _generate_example_linear_angular_speed(t):
    ...
    speed_points = ((0, 0, 0, 0), (0, 0, 0, wz), (vx, 0, 0, 0), (0, 0, 0, -wz), (0, -vy, 0, 0), (0, 0, 0, 0), (0, 0, 0, wz))
...
def main(argv):
    ...
    if FLAGS.logdir:
        np.savez(os.path.join(logdir, "action.npz"), action=actions, com_vels=com_vels, imu_rates=imu_rates)
