...
from motion_imitation.robots import laikago_pose_utils, minitaur_pose_utils


class MinitaurPoseOffsetGenerator(object):
    """A trajectory generator that return a constant leg pose."""

    def __init__(self, init_swing=0, init_extension=2.0, init_pose=None, action_scale=1.0, action_limit=0.5):
