...
class RackImitationTask(object):
    """Imitation reference motion task while on rack."""

    def __init__(
        self,
        weight=1.0,
        # TODO: Change terminal condition
    ...
    def reward(self, env):
        ...
        reward = self._pose_weight * pose_reward + self._end_effector_weight * end_effector_reward
    ...
    def _calc_reward_pose(self):
        ...
        for j in range(num_joints):
            ...
            j_pose_ref = np.array(j_state_ref[0])  # reference joint position
            j_pose_sim = np.array(j_state_sim[0])  # simulated joint position
            ...
            if j_size_ref > 0:
                ...
                pose_err += j_pose_err
                # pose_err = MSE between ref and target joint positions
