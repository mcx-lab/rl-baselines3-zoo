...
from motion_imitation.envs.sensors import sensor, space_utils
...
class LocomotionGymEnv(gym.Env):
    ...
    def __init__(self, gym_config, robot_class=None, env_sensors=None, robot_sensors=None, task=None, env_randomizers=None):
    ...
    def reset(self, initial_motor_angles=None, reset_duration=0.0, reset_visualization_camera=True):
