...
class BasePositionSensor(sensor.BoxSpaceSensor):
    ...
    def __init__(
        ...
        super(BasePositionSensor, self).__init__(
            name=name, shape=(3,), lower_bound=lower_bound, upper_bound=upper_bound, dtype=dtype  # x, y, z
        )
...
class PoseSensor(sensor.BoxSpaceSensor):
    ...
    def __init__(
        ...
        super(PoseSensor, self).__init__(
            name=name, shape=(3,), lower_bound=lower_bound, upper_bound=upper_bound, dtype=dtype  # x, y, orientation
        )
