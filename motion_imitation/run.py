...
def main():
    ...
    arg_parser.add_argument("--imit_mode", dest="imit_mode", type=str, default="full")
    arg_parser.add_argument("--enable_env_rand", dest="enable_env_rand", action="store_true", default=False)
    ...
    enable_env_rand = args.enable_env_rand and (args.mode != "test")
    env = env_builder.build_imitation_env(
        imit_mode=args.imit_mode,
