...
from motion_imitation.robots import a1, a1_robot_velocity_estimator, laikago_pose_utils, minitaur, robot_config
...
class A1Robot(a1.A1):
    ...
    def __init__(self, pybullet_client, time_step=0.002, **kwargs):
        ...
        kwargs["on_rack"] = True
        super(A1Robot, self).__init__(pybullet_client, time_step=time_step, **kwargs)
    ...
    def Reset(self, reload_urdf=True, default_motor_angles=None, reset_time=3.0):
        ...
        super(A1Robot, self).Reset(reload_urdf=reload_urdf, default_motor_angles=default_motor_angles, reset_time=-1)
