...
class RobotObservationLogger:
    ...
    def on_step(self, observations: np.ndarray, **kwargs):
...
def main():  # noqa: C901
    ...
    callbacks = [
        RobotActionLogger(savedir=stats_dir),
        RobotObservationLogger(savedir=stats_dir),
    ]
    try:
        for _ in range(args.n_timesteps):
            ...
            for callback in callbacks:
                callback.on_step(actions=action, observations=obs)
